						...
						<label className='flex flex-col justify-center'>
							<div className='grid w-full justify-items-center'>
								<input
									...
									name='name'
									placeholder='Name'
									className='bg-[#D9D9D9] md:w-full w-[90%] py-4 px-6 placeholder:font-thin  placeholder:text-sm text-[#0A0625] placeholder:text-opacity-50 2xl:placeholder:text-xl placeholder:text-[#0A0625] rounded-lg outline-none border-none font-medium'
								/>
							</div>
						</label>
						...
						<label className='flex flex-col'>
							<div className='grid w-full justify-items-center'>
								<textarea
									rows={5}
									name='message'
									placeholder='Why you want join us?'
